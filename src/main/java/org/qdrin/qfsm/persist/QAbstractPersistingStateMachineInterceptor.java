 ...
 * then start it again.
 *
 * @author Dmitry Kudrin
 *
 * @param <S> the type of state
 * @param <E> the type of event
 * @param <T> the type of persister context object
 */
public abstract class QAbstractPersistingStateMachineInterceptor<S, E, T> extends StateMachineInterceptorAdapter<S, E>
		implements StateMachinePersist<S, E, T> {

	private static final Log log = LogFactory.getLog(QAbstractPersistingStateMachineInterceptor.class);
